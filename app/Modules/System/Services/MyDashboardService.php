...
class MyDashboardService
{
    ...
    /**
     * Get aggregated data for the employee web dashboard.
     *
     * @param int $userId
     * @return array
     */
    public function getDashboardData(int $userId): array
    {
        ...
        // Web layouts have more screen estate, so we show up to 4 upcoming holidays
        $holidays = $this->unpaidLeaveService->getUpcomingHolidays(4);
        ...
        // Get 7-day attendance history log for web dashboard
        $sevenDaysAgo = Carbon::now()->subDays(6)->toDateString();
        $recentAttendance = $this->attendanceRepository->getHistory($userId, $sevenDaysAgo, $today);
